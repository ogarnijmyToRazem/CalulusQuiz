...
public class MainActivity extends AppCompatActivity {
    ...
    public void checkAnswers() {
        ...
        if(Float.parseFloat(answer2)==answer2Right){
            points+=pointsForRightAnswer;
        }
        ...
        if(Integer.parseInt(answer5)==answer5Right){
            points+=pointsForRightAnswer;
        }
    ...
    public int getAnswerRadioButton(int id1, int id2, int id3, int id4) {
        RadioButton option1 = (RadioButton) findViewById(id1);
        RadioButton option2 = (RadioButton) findViewById(id2);
        RadioButton option3 = (RadioButton) findViewById(id3);
        RadioButton option4 = (RadioButton) findViewById(id4);
    ...
    public boolean getAnswerCheckBox(int id) {
        CheckBox option = (CheckBox) findViewById(id);
